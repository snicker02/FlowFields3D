...
export const SCHEMA = [
  ...
  },
  {
    title: 'Video', open: false, controls: [
      ...
      { type: 'slider', path: 'look.videoTravelCycles', label: 'Travel loops', min: 0, max: 12, step: 1, level: 'none' },
  ...
  },
  {
    title: 'Motion and camera', open: false, controls: [
      ...
      { type: 'select', path: 'look.travelMode', label: 'Travel', options: ['Off', 'Comet', 'Dashes', 'Wipe'], level: 'draw' },
      { type: 'slider', path: 'look.travelLength', label: 'Trail length', min: 0.01, max: 1, step: 0.005, level: 'draw' },
      { type: 'slider', path: 'look.travelSpeed', label: 'Travel speed', min: -2, max: 2, step: 0.005, level: 'draw' },
